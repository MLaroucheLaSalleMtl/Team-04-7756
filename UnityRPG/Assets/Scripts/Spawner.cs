...
public class Spawner : MonoBehaviour {
    ...
    [SerializeField] GameObject prefabToSpawn;                // The prefab that should be spawned
    ...
    private float moveAmount = 5.0f;                    // The amount to move
    private float turnAmount = 5.0f;                    // The amount to turn
